...
test_that("Mapping of dataset works as expected", {
  ...
  expect_error({
    sspm_discrete %>% map_dataset(predator_simulated, name = "pred_data", time_column = "year",
                                  type = "predictor", uniqueID = "uniqueID", coords = c("lat_dec"))
  }, "`coords` must be of length 2")

  # Success cases
  mapped <- sspm_discrete %>%
    map_dataset(predator_simulated, name = "pred_data", time_column = "year", type = "predictor",
  ...
  expect_error({
    sspm_discrete %>%
      map_dataset(dataset_list, name = "pred_data", time_column = "year", type = "predictor",
                  uniqueID = "uniqueID", coords = c("lon_dec", "lat_dec"))
  ...
  expect_error({
    sspm_discrete %>%
      map_dataset(dataset_list, name = c("pred_data", "pred_data"), time_column = "year",
                  type = "predictor", uniqueID = "uniqueID", coords = c("lon_dec", "lat_dec"))
  ...
  expect_error({
    sspm_discrete %>%
      map_dataset(dataset_list, name = c("pred_data", "pred_data_2"),
                  time_column = "year", type = "predictor",
  ...
  expect_error({
    sspm_discrete %>%
      map_dataset(dataset_list, name = c("pred_data", "pred_data_2"), time_column = "year",
                  type = "predictor", uniqueID = "uniqueID", coords = list(c("lon_dec", "lat_dec"),
                                                                           c("lon_dec")))
  ...
  expect_error({
    sspm_discrete %>%
      map_dataset(dataset_list, name = c("pred_data", "pred_data_2"),
                  time_column = c("year", "year", "year"), type = "predictor",
                  uniqueID = "uniqueID", coords = c("lon_dec", "lat_dec"))
